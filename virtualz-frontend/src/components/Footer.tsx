        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://discord.gg" target="_blank" rel="noopener noreferrer" className="text-sm text-zinc-400 hover:text-vz-lime transition-colors">{t("footer.community.discord")}</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/profile" className="text-sm text-zinc-400 hover:text-vz-lime transition-colors">{t("footer.platform.analytics")}</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-display font-semibold text-white mb-4">{t("footer.shop.title")}</h3>
            <ul className="space-y-2">
              <li><Link to="/coming-soon" className="text-sm text-zinc-400 hover:text-vz-lime transition-colors">{t("footer.shop.offers")}</Link></li>
              <li><Link to="/coming-soon" className="text-sm text-zinc-400 hover:text-vz-lime transition-colors">{t("footer.shop.giftCards")}</Link></li>
              <li><Link to="/coming-soon" className="text-sm text-zinc-400 hover:text-vz-lime transition-colors">{t("footer.shop.redeem")}</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-display font-semibold text-white mb-4">{t("footer.support.title")}</h3>
            <ul className="space-y-2">
              <li><Link to="/coming-soon" className="text-sm text-zinc-400 hover:text-vz-lime transition-colors">{t("footer.support.help")}</Link></li>
              <li><Link to="/coming-soon" className="text-sm text-zinc-400 hover:text-vz-lime transition-colors">{t("footer.support.contact")}</Link></li>
              <li><Link to="/coming-soon" className="text-sm text-zinc-400 hover:text-vz-lime transition-colors">{t("footer.support.privacy")}</Link></li>
            </ul>
          </div>
        </div>
