    ...
    <section className="py-12">
      ...
      <div className="relative group">
        <button
          ...
          className="hidden sm:flex absolute -left-10 top-[72px] -translate-y-1/2 z-10 items-center justify-center bg-vz-charcoal/90 border border-slate-700 rounded-full p-2 opacity-40 group-hover:opacity-100 transition-opacity hover:bg-vz-charcoal"
        >
        ...
        <button
          ...
          className="hidden sm:flex absolute -right-10 top-[72px] -translate-y-1/2 z-10 items-center justify-center bg-vz-charcoal/90 border border-slate-700 rounded-full p-2 opacity-40 group-hover:opacity-100 transition-opacity hover:bg-vz-charcoal"
        >
