    ...
    <section className="py-12">
      ...
      <div className="relative group">
        {scrollIndex > 0 && (
          <button
            onClick={handlePrev}
            className="absolute -left-10 top-[72px] -translate-y-1/2 z-10 bg-vz-charcoal/90 border border-slate-700 rounded-full p-2 opacity-40 group-hover:opacity-100 transition-opacity hover:bg-vz-charcoal"
          >
        ...
        {scrollIndex < maxIndex && (
          <button
            onClick={handleNext}
            className="absolute -right-10 top-[72px] -translate-y-1/2 z-10 bg-vz-charcoal/90 border border-slate-700 rounded-full p-2 opacity-40 group-hover:opacity-100 transition-opacity hover:bg-vz-charcoal"
          >
