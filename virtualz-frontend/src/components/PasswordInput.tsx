  ...
  return (
    <div className="relative">
      <input
        ...
        required={required}
        minLength={minLength}
        className="w-full bg-vz-charcoal border border-slate-700 rounded-lg px-4 py-2.5 pr-11 text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-vz-lime"
      />
      <button
        type="button"
